# [SOLVED] Android-Studio-Error-Quot-Manifest-Merger-Failed-Apps-Target
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/android-studio-error-quot-manifest-merger-failed-apps-target)
>
...
Update project structure and manifest file to specify an explicit value for android:exported, then try running the project again.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/android-studio-error-quot-manifest-merger-failed-apps-target)**
